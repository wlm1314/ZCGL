...
public class ZcbgAdapter extends BindingAdapter<ZcbgBean.ListBean> {
    ...
    @Override
    public void convert(BindingViewHolder holder, ZcbgBean.ListBean o, int position) {
